...
$submenu['nklaytintudong']=$lang_module['Nhatkitintudong'];
$submenu['add_cat']=$lang_module['taonhomcm'];
$submenu['config'] = $lang_module['config'];
$submenu['test'] = $lang_module['test'];
$allow_func = array( 'main','add_cat','article','publtime','exptime','nklaytintudong','del_chuyenmuc','config','getcontent','saveconfig','getarea','add_news','rss','getxml','savenews','test','alias','del_content','saveconfigauto','saveconfigcm');
