...
$link=$nv_Request->get_string('link_article','post','');
if($link!="" && $link!=null && nv_is_url ( $link ))
{
    ...
    if($site!="")
    {
        $tam=InsertNews::GetValue($link,$titleLink,$descripLink,$contentLink);
        $rowcontent['title']=$tam['tieude'];
        $rowcontent['hometext']=$tam['mota'];
        $rowcontent['bodyhtml']=$tam['noidung'];
    }
}
if ($nv_Request->get_int('save', 'post') == 1)
{
    ...
    $numselect=0;
    if(!empty($alias) && $rowcontent['id']==0)
    {
