...
$lang_module['Nhatkitintudong']="Nhật kí lấy tin tự động";

$lang_module['chonchuyenmuc']="Chọn chuyên mục";
$lang_module['luachon']="Lựa chọn";
$lang_module['laytintheo']="Lấy tin theo: ";
$lang_module['rss']="RSS";
$lang_module['noidung']="Trang nguồn";
$lang_module['chonsite']="Chọn trang web cần xem thông tin:";
$lang_module['duongdansai']="Đường dẫn không tồn tại!";
$lang_module['tontai']="Dữ liệu đã tồn tại trong hệ thống";
$lang_module['isrss']="Là trang tin RSS?";
$lang_module['quantricm']="Quản trị chuyên mục";
$lang_module['taonhomcm']="Tạo nhóm chuyên mục";
$lang_module['quaylaitruoc']="Quay lại trang trước";
$lang_module['noidungtd']="Nội dung tiêu đề";
$lang_module['noidungmt']="Nội dung mô tả";
$lang_module['autoarticle']="Tìm nội dung của trang chuyên mục không có RSS";
$lang_module['save_article'] = "Lưu bài viết";
$lang_module['getcontent']="Lấy bài viết theo link";
$lang_module['notcontent']="Không lấy được nội dung!";
$lang_module['noidungbaiviet']="Nội dung bài viết";
$lang_module['linkbaiviet']="Lấy bài viết theo link";
$lang_module['cungcaprss'] = "Những trang cung cấp RSS";
$lang_module['kocungcaprss']="Những trang không cung cấp RSS";
$lang_module['linkchuyenmuc'] ="Đường dẫn tới chuyên mục";
$lang_module['tudieuchinhtg'] = "Tự điều chỉnh thời gian lấy tin";
$lang_module['themcm'] = "Thêm chuyên mục";
$lang_module['suacm']="Sửa chuyên mục";
$lang_module['taonhomlaytin'] ="Tạo nhóm các chuyên mục";
$lang_module['co'] = "Có";
$lang_module['khong'] = "Không";
$lang_module['thoigiandieuchinh']="Thời gian điều chỉnh";
$lang_module['tgbd']="Thời gian bắt đầu";
$lang_module['tgtt']="Thời gian tiếp theo";
$lang_module['tglap']="Thời gian lặp";
$lang_module['sotinmoi']="Số tin mới";
$lang_module['trangthai']="Trạng thái";
$lang_module['noauto']="Không lấy tự động";
$lang_module['auto']="Lấy tự động";
$lang_module['nhohon10']="Nhỏ hơn 5 phần trăm tổng số tin tăng :";
$lang_module['lonhon30']="Lớn hơn 15 phần trăm tổng số tin giảm :";
$lang_module['phut']=" Phút";
$lang_module['laytintheo'] = "Lấy tin theo:";
$lang_module['trangweb'] = "Trang web";
$lang_module['chuyenmuc'] = "Chuyên mục";
$lang_module['xoachuyenmuc'] = "Xóa chuyên mục";
$lang_module['gomnhomtintudong'] =
    "Gom nhóm các tin tự động thành các chuyên mục";
...
$lang_module['error_save_new_id'] = "Không thêm được dữ liệu có tiêu đề:";
$lang_module['rss'] = "Lấy tin theo chuyên mục";
$lang_module['laytin'] = "Lấy tin";
$lang_module['quaylai'] = "Quay lại";
$lang_module['error_sametitle'] = "Tin tức đã được lưu trong hệ thống";
$lang_module['edit'] = "Sửa";
$lang_module['test'] = "Test";
$lang_module['linksite'] = "Trang tin";
$lang_module['chuyenmuc'] = "Tên chuyên mục";
$lang_module['main'] = "Quản trị tin tức";
$lang_module['config'] = "Cấu hình";
$lang_module['addnews'] = "Thêm bài viết";
$lang_module['config_auto_article'] = "Tìm nội dung bài viết chi tiết";
...
$lang_module['errorsave'] =
    "Lỗi hệ thống không cập nhật được nội dung, bạn hãy kiểm tra lại liên kết tĩnh tiêu đề bài viết có thể bị trùng";
$lang_module['saveok'] = "Cập nhật bài viết thành công";
$lang_module['clickgotomodule'] =
    "Click vào đây để chuyển vào trang quản lý bài viết.";
...
$lang_module['delcat_msg_cat'] =
    "Chuyên mục này có %s Chuyên mục thành phần, bạn cần xóa hoặc di chuyển các Chuyên mục thành phần trước";
$lang_module['delcat_msg_rows'] =
    "Chuyên mục có %s bài viết, bạn có chắc chắn xóa hoặc di chuyển sang Chuyên mục khác";
...
$lang_module['delcat_msg_rows_move'] =
    "Hoặc chọn Chuyên mục để di chuyển bài viết tới";
$lang_module['delcatandrows'] = "Xóa Chuyên mục và các bài viết";
$lang_module['delcat_msg_rows_noselect'] =
    "Bạn cần chọn Chuyên mục để di chuyển bài viết tới";
$lang_module['deltopic_msg_rows'] =
    "nhóm tin liên quan có %s bài viết, bạn có chắc chắn xóa, khi đó nhóm tin liên quan sẽ bị xóa khỏi các bài viết.";
...
$lang_module['setting_imagefull'] =
    "Kích thước của hình dưới phần mở đầu bài viết ";
$lang_module['setting_per_page'] =
    "Số bài viết được hiển thị cùng với phần giới thiệu ngắn gọn trên một trang";
...
$lang_module['setting_auto_postcomm'] =
    "Tự động đăng thảo luận không cần qua kiểm duyệt";
$lang_module['setting_copyright'] =
...
$lang_module['search_note'] =
    "Từ khóa tìm kiếm không ít hơn 2 ký tự, không lớn hơn 64 ký tự, không dùng các mã html";
...
$lang_module['content_keywords_note'] =
    "Để tạo tự động, hãy copy toàn bộ nội dung bài viết vào ô trống dưới đây và bấm";
...
$lang_module['content_bodytext_note'] =
    " (Chỉ hiển thị đối với những đối tượng được phép xem)";
...
$lang_module['comment_nocheck'] =
    "Hãy chọn ít nhất 1 bình luận để có thể thực hiện";
...
$lang_module['topic_nocheck'] =
    "Hãy chọn ít nhất 1 bài viết để có thể thực hiện";
$lang_module['topic_delete_confirm'] =
    "Bạn có chắc muốn xóa nhóm tin liên quan ra khỏi bài viết ?";
$lang_module['topic_delete_success'] = "Loại bỏ thành công !";
$lang_module['topic_nonews'] =
    "Hiện tại không có bài viết nào thuộc nhóm tin liên quan này !";
...
$lang_module['admin_module_for_user'] =
    "Bạn có tất cả các quyền hạn của module, trừ chức năng phân quyền quản lý";
$lang_module['admin_cat'] = "Quản lý Chuyên mục";
$lang_module['admin_cat_for_user'] = "Quyền hạn của bạn tại các chuyên mục";
$lang_module['admin_no_user'] =
    "Chức năng phân quyền cho module này chỉ áp dụng cho người điều hành module, bạn cần thêm người điều hành module trước khi tiến hành phân quyền.";
...
$lang_module['permissions_pub_error'] =
    "Lỗi: Bạn không được đăng bài viết tại Chuyên mục: %1\$s";
$lang_module['error_no_del_content_id'] =
    "Lỗi: Hệ thống không xóa được các bài viết có id:";
$lang_module['structure_image_upload'] =
    "Ảnh upload của module được lưu trữ mặc định theo cấu trúc thư mục";
$lang_module['config_source'] =
