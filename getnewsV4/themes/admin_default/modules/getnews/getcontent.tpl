...
<!-- END: site -->
<form enctype="multipart/form-data" action="{NV_BASE_SITEURL}admin/index.php?nv={MODULE_NAME}&op=getarea&link={site}" method="post">
            ...
            $.ajax(
                {
                    ...
                    data : 'tpath='+titlepath.substring(0,titlepath.length -1)+'&hpath='+headpath.substring(0,headpath.length -1)+'&cpath='+contentpath+'&site='+site,
